        ...
        <div class="collapse navbar-collapse" id="site-nav">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @if($auth_user->type==='stu')
                    <li style="list-style: none" class="nav-item"><a href="{{route('info.about')}}" class="nav-link">About</a>
                    </li>
                @endif
                @if($auth_user->type==='hod')
                    <li style="list-style: none" class="nav-item"><a href="{{route('info.hodAbout')}}" class="nav-link">About</a>
                    </li>
                    <li style="list-style: none" class="nav-item"><a href="{{route('hods.show')}}" class="nav-link">Waiting
                            List</a></li>
                    <li style="list-style: none" class="nav-item"><a href="{{route('hods.list')}}" class="nav-link">Approved
                            List</a></li>
                @endif
            </ul>
            <li style="list-style: none" class="nav-item">
                <div class="dropdown ">
                    <button class="dropbtn"><img src=" {{asset('images/profileicon.png')}} "
                                                 style="width:25px;margin-left: -120px"/>
