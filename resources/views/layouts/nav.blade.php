<nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="site-nav">
            ...
            @if(!\Illuminate\Support\Facades\Auth::guard('stu')->check() && !\Illuminate\Support\Facades\Auth::guard('hod')->check())
            ...
            @else
                <ul class="navbar-nav ml-auto">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::guard('stu')->user())
                        @php
                            $user = auth('stu')->user();
                        @endphp
                        <li class="nav-item"><a href="{{route('info.about')}}" class="nav-link">About</a></li>
                    @endif
                    @if(\Illuminate\Support\Facades\Auth::guard('hod')->user())
                        @php
                            $user = auth('hod')->user();
                        @endphp
                    ...
                    <li class="nav-item">
                        <div class="dropdown ">
                            ...
                            <div class="dropdown-content">
                                <a href="{{route('students.edit', ['student' => $user->id])}}">Profile</a>
